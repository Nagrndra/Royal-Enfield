...
describe('AEM Forms OOTB Content Tests', () => {
    ...
    describe.skip('DataSource Tests', () => {
        let dataSources = [
            ...
            confPath = '/conf/MyNweSite/settings/cloudconfigs/fdm',
    ...
    describe('Form Data Model Tests', () => {
        ...
        let formDataModels = [
            ...
            basePath = 'aem/fdm/editor.html/content/dam/formsanddocuments-fdm/MyNweSite',
    ...
    describe('AEM Forms Templates E2E Testing', () => {
        let templates = [
                {path : '/conf/MyNweSite/settings/wcm/templates/basic-af', isBlankForm : false, verificationRuleFilePath : '../../rules/template-rules.json'},
                {path : '/conf/MyNweSite/settings/wcm/templates/blank-af', isBlankForm : true}
            ],
            tabbedLayoutCount = 0,
    ...
    describe('Theme testing', () => {
        const getThemePath = (theme) => '/content/dam/formsanddocuments-themes/MyNweSite/' + theme + '/jcr:content?wcmmode=disabled';
    ...
    describe('DataLayer testing', () => {
        ...
        const templatePath = '/conf/MyNweSite/settings/wcm/templates/blank-af-v2';
