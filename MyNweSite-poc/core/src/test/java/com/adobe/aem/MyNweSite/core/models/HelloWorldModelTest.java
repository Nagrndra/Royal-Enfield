 ...
 */
package com.adobe.aem.MyNweSite.core.models;
...
import com.adobe.aem.MyNweSite.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "MyNweSite/components/helloworld");
